 ...
 * types. The provided code is minimal and should be enough for PA4. You can freely
...
class int_value : public const_value {
	...
	public:
		int_value(int i)
		  : const_value(op_type(INT32), itos(i), true), i_value(i) {}
