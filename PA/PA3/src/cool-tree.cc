...
Expression static_dispatch_class::copy_Expression() {
    return new static_dispatch_class(expr->copy_Expression(), copy_Symbol(type_name), copy_Symbol(name),
                                     actual->copy_list());
}
...
Expression let_class::copy_Expression() {
    return new let_class(copy_Symbol(identifier), copy_Symbol(type_decl), init->copy_Expression(),
...
int object_class::check_scope(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return 0;
}

int cond_class::check_scope(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return 0;
}

int dispatch_class::check_scope(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return 0;
}

int static_dispatch_class::check_scope(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return 0;
}

int new__class::check_scope(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return 0;
}
...
int method_class::check_scope(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return 0;
}

int method_class::check_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    Symbol inferred_type = expr->infer_type(c, o);
    return 0;
}
...
Symbol object_class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return get_type();
}

Symbol new__class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return get_type();
}

Symbol int_const_class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    set_type(Int);
    return get_type();
}

Symbol string_const_class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return get_type();
}

Symbol dispatch_class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return get_type();
}
...
Symbol plus_class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    Symbol t1 = e1->infer_type(c, o);
    Symbol t2 = e2->infer_type(c, o);
...
Symbol cond_class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return get_type();
}
...
Symbol typcase_class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return get_type();
}

Symbol branch_class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return NULL;
}

Symbol static_dispatch_class::infer_type(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    // TODO
    return get_type();
}
...
int typcase_class::check_scope(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    return 0;
}

int branch_class::check_scope(Class_ c, cool::SymbolTable<Symbol, Entry> *o) {
    return 0;
}
